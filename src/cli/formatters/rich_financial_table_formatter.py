...
class RichFinancialTableFormatter:
    ...
    def create_annual_balance_sheet_table(financial_history: FinancialHistory) -> Table:
        ...
        for i, period in enumerate(periods):
            growth = balance_growth["total_assets"][i] if i < len(balance_growth["total_assets"]) else None
            formatted = RichFinancialTableFormatter._format_currency_with_growth(
        ...
        for i, period in enumerate(periods):
            growth = balance_growth["total_liabilities"][i] if i < len(balance_growth["total_liabilities"]) else None
        ...
        for i, period in enumerate(periods):
            growth = balance_growth["total_equity"][i] if i < len(balance_growth["total_equity"]) else None
            formatted = RichFinancialTableFormatter._format_currency_with_growth(
    ...
    def create_quarterly_balance_sheet_table(financial_history: FinancialHistory) -> Table:
        ...
        balance_growth = {
            "total_assets": RichFinancialTableFormatter._calculate_growth_rates(periods, "total_assets"),
            "total_liabilities": RichFinancialTableFormatter._calculate_growth_rates(periods, "total_liabilities"),
            "total_equity": RichFinancialTableFormatter._calculate_growth_rates(periods, "total_equity")
        }
        shares_growth = RichFinancialTableFormatter._calculate_shares_growth(periods)
